        ...
        <div class="page-content">
            <div class="page-bar">
                ...
                <div><br><br><br>
                    ...
                    <%if(request.getAttribute("Reason")!=null) out.print("<h1>Title : "+request.getAttribute("Reason")+"</h1>");%>
                    <label onclick="Home2()"><h1 id="txt">操作成功，4秒后将自动返回主页</h1></label>
                </div>
...
<script>
    function Home(){
        initPage();
        setTimeout("document.getElementById('txt').innerHTML='<h1>操作成功，3秒后将自动返回主页</h1>'",1000)
        setTimeout("document.getElementById('txt').innerHTML='<h1>操作成功，2秒后将自动返回主页</h1>'",2000)
        setTimeout("document.getElementById('txt').innerHTML='<h1>操作成功，1秒后将自动返回主页</h1>'",3000)
