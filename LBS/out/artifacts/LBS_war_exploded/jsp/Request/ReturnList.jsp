                ...
                <div><br><br><br>
                    ...
                    <table width="90%" class="table">
                        ...
                        <tr align="center" bgcolor="white">
                            ...
                            <%if(book.getFlag()==1){%>
                            <td><font color="red">超期,已超期<%=book.getLoanDays()%>天</font></td>
                            <%}else {%>
                            <td><font color="green">未超期</font></td>
                            <%}%>
                            <td><button type="button" class="btn green" onclick="window.location.href='ReturnBook?action=1&UserId=<%=book.getUserId()%>&UserName=<%=book.getUserName()%>&BookName=<%=book.getName()%>&BookId=<%=book.getId()%>'">还书</button></td>
                        </tr>
                        <%
                                }
                            }
