            ...
            <div class="page-bar">
                <div>
                    <ul id="page-breadcrumb" class="page-breadcrumb">
                        ...
                        <li>
                            <a href="javascript:location.reload()">归还申请</a>
                        </li>
                    </ul>
                </div>
                <div><br><br><br>
                    ...
                    <table width="90%" class="table">
                        ...
                        <tr align="center" bgcolor="white">
                            ...
                            <td>
                                <button type="button" class="btn green" onclick="window.location.href='ReturnBook?action=2&Action=1&BookId=<%=book.getBookId()%>&UserId=<%=book.getUserId()%>'">同意</button>
                                <button type="button" class="btn red" onclick="window.location.href='ReturnBook?action=2&Action=0&BookId=<%=book.getBookId()%>&UserId=<%=book.getUserId()%>'">拒绝</button>
                            </td>
                        </tr>
                        <%
