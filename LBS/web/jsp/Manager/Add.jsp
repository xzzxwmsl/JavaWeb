        ...
        <div class="page-content">
            <div class="page-bar">
                ...
                <div><br><br><br>
                    ...
                    <form class="form-horizontal" id="AddForm" action="AddUser" method="post" onsubmit="return checkSubmit()">
                        <div class="form-body">

                            <div class="form-group">
                                <label class="col-md-3 control-label">ID<font color="red">*</font></label>
                                <div class="col-md-3">
                                    <input type="text" id="UserId" name="UserId" class="form-control" placeholder="请填写Id" value=""/>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <input type="text" id="Password" name="Password" class="form-control" placeholder="请填写密码" value=""/>
                                </div>
                            </div>
