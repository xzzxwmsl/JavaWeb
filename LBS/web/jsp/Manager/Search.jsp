			...
			<div class="page-bar">
				<div>
					<ul id="page-breadcrumb" class="page-breadcrumb">
						...
						<li>
							<a href="javascript:location.reload()">读者信息</a>
						</li>
					</ul>
				</div>
				<div><br><br><br>
					...
					<table width="90%" class="table">
						...
						<tr align="center" bgcolor="white">
							...
							<td><button type="button" class="btn green" onclick="window.location.href='FindLoan?action=2&UserId=<%=user.getUserId()%>'">借阅信息</button>
								<button type="button" class="btn blue" onclick="window.location.href='jsp/Manager/Update.jsp?UserId=<%=user.getUserId()%>'">修改</button>
								<button type="button" class="btn red" onclick="window.location.href='DeleteUser?UserId=<%=user.getUserId()%>'">删除</button>
							</td>
						</tr>
						<%
									}
