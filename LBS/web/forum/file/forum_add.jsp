									...
									<form class="form-horizontal" role="form" id="page_form" name="page_form" action="#">
										...
										<div class="form-body">
											<div class="form-group">
												...
												<div class="col-md-9">
													<select class="table-group-action-input form-control input-medium" id="forum_id" name="forum_id">
...
<!-- BEGIN PAGE SCRIPTS -->
<script type="text/javascript" src="../../assets/module/scripts/forum/file/forum_add.js"></script>
<!-- END PAGE LEVEL SCRIPTS -->
